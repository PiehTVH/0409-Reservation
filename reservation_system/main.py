...
app.add_middleware(DBSessionMiddleware,
                   db_url=os.getenv('DATABASE_URL', 'postgresql://postgres:a@localhost:5432/reservation'))
...
def create_tables():
    database_url = os.getenv('DATABASE_URL', 'postgresql://postgres:a@localhost:5432/reservation')
